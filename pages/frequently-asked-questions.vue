  ...
  <section class="main">
    <div class="container">
      <markdown-body>
        ...
        <div class="faq">
          <blockquote>What is a mini program?</blockquote>
        ...
        <div class="faq">
          ...
          <p>Right now, only English. If you're interested in translating WeChat documentation into another language, feel free to get in contact.</p>
        </div>                        
      </markdown-body>
    </div>
  </section>
